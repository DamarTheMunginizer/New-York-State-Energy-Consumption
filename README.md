...
Due: Friday, January 10 at 10 AM Eastern time.


## The Work

The prompts are there to help jump-start your ideation process. If you would like to change or combine prompts, that's fine! If you want to find your own idea, even better. **Consult your instructor for final approval before getting started.**  
...
## Requirements
For the purposes of this project, you must meet a few technical requirements. They are:
...
**Questions**: Questions should be sent to your instructor. **Questions should be specific, brief, and formatted.**
...
- *As with presentations in the "real world," there is no required time limit.* Your presentation should be long enough to cover all relevant aspects of the problem, but not so long that it obscures the takeaways of the presentation. (Your group should likely aim for somewhere around 20 minutes, but it is possible that you may need a different amount of time for your presentation.)
